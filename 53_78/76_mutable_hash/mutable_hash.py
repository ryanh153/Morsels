...
# TODO: For the third bonus need to make this a class whose register method is a returns a decorator and adds it to a
#  set of types that have a defined hash function
